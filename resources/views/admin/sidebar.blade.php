<div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        ...
        <li class=""><a href="/table"><i class="icon-table2"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Basic Tables</span></a>
        </li>

        <li class=""><a href="/faculties"><i class="icon-table2"></i>
                <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Faculties</span></a>
        </li>
        <li class=""><a href="/faculties"><i class="icon-table2"></i>
                <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Faculties</span></a>
        </li>
